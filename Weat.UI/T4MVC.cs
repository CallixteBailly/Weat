...
{
    public static Weat.UI.Controllers.AccountController Account = new Weat.UI.Controllers.T4MVC_AccountController();
    public static Weat.UI.Controllers.HomeController Home = new Weat.UI.Controllers.T4MVC_HomeController();
    public static Weat.UI.Controllers.ManageController Manage = new Weat.UI.Controllers.T4MVC_ManageController();
    public static T4MVC.PersonController Person = new T4MVC.PersonController();
