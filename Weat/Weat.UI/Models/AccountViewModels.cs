...
namespace Weat.UI.Models
{
    public class AccountContext : DbContext
    {
        ...
        public DbSet<ResetPasswordViewModel> RessetPassword { get; set; }
        public DbSet<SendCodeViewModel> SendCode { get; set; }
        public DbSet<VerifyCodeViewModel> VerifyCode { get; set; }
